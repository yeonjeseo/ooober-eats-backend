...
var login_dto_1 = require("../users/dtos/login.dto");
var RestaurantResolver = /** @class */ (function () {
    ...
    __decorate([
        (0, graphql_1.Query)(function (returns) { return [restanrant_entity_1.Restaurant]; })
    ...
    __decorate([
        (0, graphql_1.Mutation)(function (returns) { return login_dto_1.LoginOutput; }),
        __param(0, (0, graphql_1.Args)('input'))
    ], RestaurantResolver.prototype, "updateRestaurant");
    RestaurantResolver = __decorate([
        (0, graphql_1.Resolver)(function (of) { return restanrant_entity_1.Restaurant; })
    ], RestaurantResolver);
