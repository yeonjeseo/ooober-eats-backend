...
var jwtMiddleware = /** @class */ (function () {
    function jwtMiddleware(jwtService, usersService) {
    ...
    jwtMiddleware.prototype.use = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!('x-jwt' in req.headers)) return [3 /*break*/, 5];
                        token = req.headers['x-jwt'];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        decoded = this.jwtService.verify(token.toString());
                        if (!(typeof decoded === 'object' && decoded.hasOwnProperty('id'))) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.usersService.findById(decoded['id'])];
                    case 2:
                        user = _a.sent();
                        req['user'] = user;
                        _a.label = 3;
